...
* **REMOVE ANY OLD VERSIONS OF THE PRODUCT BEFORE INSTALLING**
  * Delete `<KSP_ROOT>/GameData/DropTankWrapper`
* Extract the package's `DropTankWrapper/` folder into your KSP's GameData folder as follows:
  * `<PACKAGE>/DropTankWrapper` --> `<KSP_ROOT>/GameData`
    * Overwrite any preexisting folder/file(s).
  * you should end up with `<KSP_ROOT>/GameData/DropTankWrapper`
